...
public static class Request extends HttpConnection.Base<Connection.Request> implements Connection.Request {
    ...
    public boolean validateSSLCertificates=true;
    public Request(){
...
public static class Response extends HttpConnection.Base<Connection.Response> implements Connection.Response {
    ...
    public static Response execute(    Connection.Request req,    Response previousResponse) throws IOException {
      ...
      try {
        conn.connect();
        if (req.method() == Connection.Method.POST)         writePost(req,conn.getOutputStream(),mimeBoundary);
 ...
 * @throws IOException
 */
    public static synchronized void initUnSecureSSL() throws IOException {
    ...
    public static String setupMultipartModeIfNeeded(    final Connection.Request req){
