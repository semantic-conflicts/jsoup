 ...
 */
  ...
  public void normaliseTextNodes(  Element element){
  ...
  public void normaliseStructure(  String tag,  Element htmlEl){
  ...
  public Element findFirstElementByTagName(  String tag,  Node node){
    if (node.nodeName().equals(tag))     return (Element)node;
 else {
 ...
 */
  @Override public Element text(  String text){
    body().text(text);
    return this;
  }
 ...
 */
  public void ensureMetaCharsetElement(){
 ...
 */
    ...
    public Charset charset;
    public ThreadLocal<CharsetEncoder> encoder=new ThreadLocal<CharsetEncoder>(){
 ...
 */
    ...
    @Override public OutputSettings clone(){
 ...
 */
  ...
  public enum QuirksMode {  noQuirks,   quirks,   limitedQuirks}
